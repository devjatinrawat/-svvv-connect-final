...
const Achievement = () => {
  return (
    <section className='w-full container-fluid p-5'>
        <div className='md:max-w-[1100px] m-auto grid md:grid-cols-2 max-w-[400px]'>
            <div className='flex flex-col justify-start gap-4'>
                <h1 className='md:leading-[42px] py-2 text-3xl font-semibold'>
                    Our <span className='text-[#007aff]'>Achievements</span>
                </h1>
                ...
                <div className='grid md:grid-cols-2 grid-cols-1'>
                    <div className="py-6 flex">
                        <div className="p-4 bg-[#e9f8f3] rounded-xl">
                            <FaGraduationCap size={30} style={{ color:'##007aff' }}/>
                        </div>
                        <div className='px-3'>
                    ...
                    <div className="py-6 flex">
                        <div className="p-4 bg-[#e9f8f3] rounded-xl">
                            <AiFillVideoCamera size={30} style={{ color:'#007aff' }}/>
                        </div>
                        <div className='px-3'>
                    ...
                    <div className="py-6 flex">
                        <div className="p-4 bg-[#e9f8f3] rounded-xl">
                            <FaPeopleCarry size={30} style={{ color:'#007aff' }}/>
                        </div>
                        <div className='px-3'>
