        ...
        <div className='md:max-w-[1100px] m-auto grid md:grid-cols-5 max-[768px]:md:grid-cols-6 gap-8 max-w-[400px]'>
            <div className='col-span-1'>
                ...
                <div className="flex gap-4 py-4">
                    <div className="p-4 rounded-xl bg-[#FFAD25] cursor-pointer"><FaFacebook size={25}/></div>
                    <div className="p-4 rounded-xl bg-[#FFAD25] cursor-pointer"><FaTwitter size={25}/></div>
                    <div className="p-4 rounded-xl bg-[#FFAD25] cursor-pointer"><FaLinkedin size={25}/></div>
                    <div className="p-4 rounded-xl bg-[#FFAD25] cursor-pointer"><FaYoutube size={25}/></div>
                </div>
            </div>    
                ...
                <div className='col-span-2'>
                    ...
                    <button className='my-2 px-5 py-3 bg-[#007aff] text-white'>Subscribe</button>
                </form>
                </div>
            </div>
    </section>
